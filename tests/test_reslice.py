...
def test_reslice_mnisym():
    """ This is a test for the inverse deformation"""
    T1_file = 'SUITPy/templates/tpl-MNI152NLin2009cSymC_T1w.nii.gz'
    def_file = 'docs/source/tutorials/sub-ex_T1w_from-MNISym_mode-image_xfm.nii.gz'
    img = suit.reslice_image(T1_file,def_file)
    nb.save(img,'docs/source/tutorials/tpl-MNISym_space-ex_resliced.nii.gz')
    pass
